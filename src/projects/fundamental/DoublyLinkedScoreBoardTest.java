...
class DoublyLinkedScoreBoardTest {
    DoublyLinkedScoreBoard emptyBoard;
    DoublyLinkedScoreBoard fullBoard;
    ...
    @BeforeEach
    void init() {
        emptyBoard = new DoublyLinkedScoreBoard();
        fullBoard = new DoublyLinkedScoreBoard();
